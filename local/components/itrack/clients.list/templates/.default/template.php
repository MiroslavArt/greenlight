    ...
    <div id="clients-wrapper" class="wrapper">
        ...
        <div class="title_container">
            <div class="title_block">
                <h2 class="block_title">Клиенты</h2>
            </div><!-- END title_block -->
        ...
        <?php if (!empty($arResult['ITEMS'])) : ?>
            <ul id="clients-list" class="data_table">
                ...
                <?php foreach ($arResult['ITEMS'] as $arItem) : ?>
                    <li class="row">
                        ...
                        <div class="table_block links_column item8" data-name="Ссылки"><a href="#" class="link ico_doc"><span>Список договоров страхования</span></a>
                        </div>
                    </li>
                <?php endforeach; ?>
            </ul><!-- END data_table -->
