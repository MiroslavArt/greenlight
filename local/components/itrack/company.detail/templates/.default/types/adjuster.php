...
<div id="contracts-wrapper" class="wrapper">
    <a href="<?=$arParams['LIST_URL']?>" class="back">Вернуться к списку аджастеров</a>
    <div class="title_container">
        <div class="title_block">
            <span class="type_page">Карточка аджастера</span>
        ...
        <div class="title_right_block">
            <form class="search_form js-submit js-needs-validation" method="get"
                ...
                <input type="text" name="search"  class="search_text" placeholder="Поиск по списку клиентов"/>
