...
<h2 class="block_title"><? if($arParams['TYPE']==3) {
        echo "Корреспонденция";
    } else if($arParams['TYPE']==4) {
        echo "Отчеты";
    } ?></h2>
<div class="doc_conti">
    <ul class="doc_list">
    ...
    <form class="upload_doc_container" data-id="<?=$arParams['LOST_DOC']?>" data-type="<?=$arParams['TYPE']?>">
